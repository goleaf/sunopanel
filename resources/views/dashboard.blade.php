    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="card bg-base-200 mb-8">
            <div class="card-body text-center">
                <h1 class="card-title text-3xl font-bold justify-center mb-2">Welcome to SunoPanel</h1>
                <p class="text-base-content/80">Your complete music management system</p>
            </div>
        </div>
